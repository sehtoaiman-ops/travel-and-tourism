...
exports.updateBookingStatus = exports.getAllBookings = exports.createHotel = exports.deletePackage = exports.updatePackage = exports.createPackage = exports.updateUserRole = exports.getAllUsers = exports.getAdminStats = void 0;
...
const createPackage = async (req, res, next) => {
    try {
        const { name, description, categoryId, destinationId, durationDays, price, maxGuests, image, difficulty, carbonFootprint, highlights, itinerary, inclusions, exclusions, capacity, dates, } = req.body;
...
const updatePackage = async (req, res, next) => {
    try {
        ...
        if (updateData.durationDays)
            updateData.durationDays = parseInt(updateData.durationDays);
        if (updateData.price)
            updateData.price = parseFloat(updateData.price);
        if (updateData.maxGuests)
            updateData.maxGuests = parseInt(updateData.maxGuests);
        if (updateData.carbonFootprint)
            updateData.carbonFootprint = parseFloat(updateData.carbonFootprint);
