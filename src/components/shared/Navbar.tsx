        ...
        <div className="hidden lg:flex items-center space-x-6">
          ...
          {onOpenAiAssistant && (
            <button
              ...
              className="p-2 rounded-full text-white hover:text-gold hover:bg-forest/5 transition-all duration-300"
          ...
          {isAuthenticated ? (
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/login"
                className="font-inter text-xs tracking-widest uppercase text-gold hover:text-gold transition-colors"
              >
                Sign In
              </Link>
              <Link
